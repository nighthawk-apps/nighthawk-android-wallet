...
object DarkfiMobileFfiApi {
    ...
    fun buildBootstrapConfig(
        ...
        return DrkBootstrapConfig(
            ...
            darkfidEndpointUrl = wallet.endpoint.toDisplayString(),
            birthdayHeight = wallet.birthdayHeight ?: -1L,
        )
    }
     ...
     * (network label, mnemonic words, darkfid endpoint display URL).
     */
