...
class DarkfiMobileFfiBootstrapConfigTest {
    ...
    @org.junit.Before
    fun setUp() {
        val prefs = context.getSharedPreferences("test_prefs_bootstrap", android.content.Context.MODE_PRIVATE)
        val field = com.nighthawkapps.lib.android.sdk.wallet.DrkWalletPassStore::class.java.getDeclaredField("instance")
    ...
    fun buildBootstrapConfig_mapsFields() {
        ...
        assertEquals(wallet.endpoint.toDisplayString(), config.darkfidEndpointUrl)
