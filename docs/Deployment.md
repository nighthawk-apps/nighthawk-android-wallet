...
For **3.00.010** (`WALLET_VERSION_CODE=30001810`):

1. Confirm `gradle.properties` versions and Fastlane changelog `fastlane/metadata/android/en-US/changelogs/30001810.txt`.
...
4. Tag `v3.00.010` on the commit F-Droid should build. Do not invent fdroid.org listing URLs until the fdroiddata MR merges.
