...
Pinned revision: **`docs/upstream/darkfi-revision.txt`** (fetch with `scripts/fetch-darkfi-upstream-reference.sh`).
...
| Scan against testnet `darkfid` | Manual / CI job with secrets |
