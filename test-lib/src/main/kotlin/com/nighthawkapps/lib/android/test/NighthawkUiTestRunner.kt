package com.nighthawkapps.lib.android.test
...
class NighthawkUiTestRunner : AndroidJUnitRunner() {
    ...
    override fun onCreate(arguments: Bundle?) {
        ...
        wakeLock = powerManager.newWakeLock(flags, "nighthawk:keep_screen_on_for_tests")
    }
