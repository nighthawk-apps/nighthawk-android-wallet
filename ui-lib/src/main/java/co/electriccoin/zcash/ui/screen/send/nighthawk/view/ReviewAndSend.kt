...
fun ReviewAndSendPreview() {
    ZcashTheme(darkTheme = false) {
        Surface {
            ReviewAndSend(sendAndReviewUiState = SendAndReviewUiState(), onBack = {}, onViewOnExplorer = {}, onSendZCash = {})
        }
    }
}
...
fun ReviewAndSend(
    ...
    Column(modifier = Modifier
        ...
        Row(
            ...
            BodyMedium(text = stringResource(id = R.string.ns_pool), color = ZcashTheme.colors.surfaceEnd)
            BodyMedium(text = sendAndReviewUiState.pool, color = ZcashTheme.colors.surfaceEnd)
        }
        ...
        TextButton(onClick = onViewOnExplorer,
