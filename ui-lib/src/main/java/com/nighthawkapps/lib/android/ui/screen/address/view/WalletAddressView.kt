    ...
    Column(modifier) {
        Row(
            ...
            Column(Modifier.fillMaxWidth()) {
                walletAddresses.privateAddresses.forEachIndexed { index, address ->
                    ExpandableRow(
                        title = stringResource(R.string.ns_private_address) + " ${index + 1}",
                        content = address,
                ...
                Row(
                    ...
                    modifier =
                        Modifier
                            ...
                            .clickable { /* Pending FFI support */ }
                            .padding(
                                horizontal = WalletTheme.dimens.spacingDefault,
                                vertical = WalletTheme.dimens.spacingTiny
                            )
                ) {
                    ListItem(text = stringResource(R.string.ns_create_new_address))
                }
            }
        }
    }
