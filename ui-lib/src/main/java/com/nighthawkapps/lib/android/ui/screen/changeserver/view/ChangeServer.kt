...
fun ChangeServer(
    ...
    Column(
        ...
        if (showRestartDialog) {
            ...
            AlertDialog(
                title = stringResource(id = R.string.ns_restart_required),
                desc = stringResource(id = R.string.ns_server_added_restart_desc),
                confirmText = stringResource(id = R.string.ns_restart_now),
                dismissText = stringResource(id = R.string.ns_later),
                onConfirm = {
