package com.nighthawkapps.lib.android.ui.screen.fiatcurrency.model

/**
 * @param currencyName is the currency representation
 * @param currencyText is used to show the Text in UI
 * @param serverUrl metric slug passed to the fiat pricing helper for DRK quotes
 */
...
data class FiatCurrencyUiState(
