        ...
        content = {
            Scaffold(topBar = {
                ...
                HomeMainContent(
                    ...
                    modifier =
                        Modifier.padding(
                            top = paddingValues.calculateTopPadding() + WalletTheme.dimens.spacingLarge,
...
private fun isSyncing(status: DarkfiSyncStatus): Boolean = status == DarkfiSyncStatus.SYNCING
