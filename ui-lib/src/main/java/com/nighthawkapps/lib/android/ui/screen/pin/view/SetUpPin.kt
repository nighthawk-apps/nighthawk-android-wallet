...
import com.nighthawkapps.lib.android.ui.common.SUCCESS_VIBRATION_PATTERN
...
fun SetUpPin(
    ...
    Column(
        ...
        val pinCodeSetupDoneMessage = stringResource(R.string.pin_code_setup_done)
        ...
        val firstTimeEnteredPassword =
            remember {
                mutableStateOf("")
            }
        val secondEnteredPassword =
            remember {
                mutableStateOf("")
            }
        val isFirstFullPasswordEntered =
            remember {
                derivedStateOf {
                    firstTimeEnteredPassword.value.length == WALLET_PASSWORD_LENGTH
                }
            }
        val isSecondFullPasswordEntered =
            remember {
                derivedStateOf {
        ...
        val incorrectPassword =
            remember {
                derivedStateOf {
                    isFirstFullPasswordEntered.value && isSecondFullPasswordEntered.value &&
                        secondEnteredPassword.value != firstTimeEnteredPassword.value
                }
            }
