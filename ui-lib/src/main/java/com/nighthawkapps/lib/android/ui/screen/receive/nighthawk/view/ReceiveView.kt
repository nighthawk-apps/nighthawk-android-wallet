...
package com.nighthawkapps.lib.android.ui.screen.receive.nighthawk.view
...
fun ReceiveView(
    ...
    Column(
        ...
        NighthawkTopBar(
            ...
            title = null,
            leadingContentDescription = stringResource(R.string.receive_back_content_description),
        )
        Image(
