package com.nighthawkapps.lib.android.ui.screen.syncnotification.viewmodel
...
class SyncNotificationViewModel(
    val context: Application
) : AndroidViewModel(application = context) {
    @OptIn(ExperimentalCoroutinesApi::class)
    val syncIntervalOption =
        flow {
